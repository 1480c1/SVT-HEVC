    ...
    const EB_U32      predictionBufferStride)     //input parameter, denotes the stride for the prediction ptr
{
    ...
    IntraAngVertical_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
        size,
        refSampMain,
        predictionPtr,
        predictionBufferStride,
    ...
    EB_BOOL          *LeftReadyFlag)
{
   ...
   IntraAngHorizontal_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
        size,
        refSampMain,
        predictionPtr,
        predictionBufferStride,
    ...
    EB_BOOL          *LeftReadyFlag)
{
    ...
    switch(mode){
        case 34:
            ...
            IntraAng34_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                refSamples,
                predictionPtr,
                predictionBufferStride,
        ...
        case 25: case 24: case 23: case 22: case 21: case 20: case 19:
            ...
            break;
        case 18:
            IntraAng18_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                refSamples,
                predictionPtr,
                predictionBufferStride,
        ...
        case 2:
            ...
            IntraAng2_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                refSamplesReverse,
                predictionPtr,
                predictionBufferStride,
    ...
    ModeDecisionCandidateBuffer_t		   *candidateBufferPtr)
{
	...
	if (componentMask & PICTURE_BUFFER_DESC_LUMA_MASK) {
        ...
        case 3:
            ...
            IntraHorzLuma_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                yIntraReferenceArray,
                &(candidateBufferPtr->predictionPtr->bufferY[puOriginIndex]),
                candidateBufferPtr->predictionPtr->strideY,
    ...
    if (componentMask & PICTURE_BUFFER_DESC_CHROMA_MASK) {
        ...
        case 2:
            ...
            // Cb Intra Prediction
            if (componentMask & PICTURE_BUFFER_DESC_Cb_FLAG) {
                IntraVerticalChroma_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                    chromaPuSize,
        ...
        case 3:
            ...
            // Cb Intra Prediction
            if (componentMask & PICTURE_BUFFER_DESC_Cb_FLAG) {
				IntraHorzChroma_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                    chromaPuSize,
                    contextPtr->cbIntraReferenceArrayReverse,
                    &(candidateBufferPtr->predictionPtr->bufferCb[puChromaOriginIndex]),
                    candidateBufferPtr->predictionPtr->strideCb,
        ...
        case 1:
            ...
            // Cb Intra Prediction
            if (componentMask & PICTURE_BUFFER_DESC_Cb_FLAG) {
				IntraDCChroma_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                    chromaPuSize,
                    contextPtr->cbIntraReferenceArrayReverse,
                    &(candidateBufferPtr->predictionPtr->bufferCb[puChromaOriginIndex]),
                    candidateBufferPtr->predictionPtr->strideCb,
    ...
    EB_U32                                  componentMask)
{
    ...
    if (componentMask & PICTURE_BUFFER_DESC_LUMA_MASK) {
        ...
        case EB_INTRA_PLANAR:
        IntraPlanar_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                yIntraReferenceArrayReverse,
        ...
        case EB_INTRA_DC:
            IntraDCLuma_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                yIntraReferenceArrayReverse,
                (EB_U16*)predictionPtr->bufferY + lumaOffset,
                predictionPtr->strideY,
        ...
        case EB_INTRA_VERTICAL:
            IntraVerticalLuma_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                yIntraReferenceArrayReverse,
                (EB_U16*)predictionPtr->bufferY + lumaOffset,
                predictionPtr->strideY,
        ...
        case EB_INTRA_HORIZONTAL:
            IntraHorzLuma_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puSize,
                yIntraReferenceArrayReverse,
                (EB_U16*)predictionPtr->bufferY + lumaOffset,
                predictionPtr->strideY,
    ...
    if (componentMask & PICTURE_BUFFER_DESC_CHROMA_MASK) {
        ...
        case EB_INTRA_VERTICAL:
            IntraVerticalChroma_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puChromaSize,
                cbIntraReferenceArrayReverse,
                (EB_U16*)predictionPtr->bufferCb + chromaOffset,
                predictionPtr->strideCb,
        ...
        case EB_INTRA_HORIZONTAL:
            IntraHorzChroma_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puChromaSize,
                cbIntraReferenceArrayReverse,
                (EB_U16*)predictionPtr->bufferCb + chromaOffset,
                predictionPtr->strideCb,
        ...
        case EB_INTRA_DC:
            IntraDCChroma_16bit_funcPtrArray[!!(ASM_TYPES & AVX2_MASK)](
                puChromaSize,
                cbIntraReferenceArrayReverse,
                (EB_U16*)predictionPtr->bufferCb + chromaOffset,
                predictionPtr->strideCb,
