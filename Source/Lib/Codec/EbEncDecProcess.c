    ...
    EB_U8                             pingpongIdxLeft)
{
    ...
    case 1: // EO - 0 degrees
        ...
        SaoFunctionTableEO_0_90[!!(ASM_TYPES & AVX2_MASK)][(saoPtr->saoTypeIndex[isChroma]) - 1][((lcuHeight & 15) == 0) && ((lcuWidth & 15) == 0) && (lcuWidth >= 32)](
            reconSamplePtr,
            reconStride,
            temporalBufferLeft,
            ReorderedsaoOffset,
    ...
    case 3: // EO - 135 degrees
        ...
        SaoFunctionTableEO_135_45[!!(ASM_TYPES & AVX2_MASK)][(saoPtr->saoTypeIndex[isChroma]) - 3][(lcuHeight == MAX_LCU_SIZE_REMAINING) && ((lcuWidth & 15) == 0) && (lcuWidth >= 32)][((lcuHeight & 15) == 0) && ((lcuWidth & 15) == 0) && (lcuWidth >= 32)](
            reconSamplePtr,
            reconStride,
            temporalBufferLeft,
            temporalBufferUpper,
    ...
    case 5: // BO
        ...
        SaoFunctionTableBo[!!(ASM_TYPES & AVX2_MASK)][((lcuWidth & 15) == 0 && (lcuHeight != MAX_LCU_SIZE_REMAINING))](
            reconSamplePtr,
            reconStride,
    ...
    EB_U8                             pingpongIdxLeft)
{
    ...
    case 1: // EO - 0 degrees
        ...
        SaoFunctionTableEO_0_90_16bit[!!(ASM_TYPES & AVX2_MASK)][(saoPtr->saoTypeIndex[isChroma]) - 1][((lcuHeight & 15) == 0) && ((lcuWidth & 15) == 0) && (lcuWidth >= 32)](
            reconSamplePtr,
            reconStride,
            temporalBufferLeft,
            ReorderedsaoOffset,
    ...
    case 3: // EO - 135 degrees
        ...
        SaoFunctionTableEO_135_45_16bit[!!(ASM_TYPES & AVX2_MASK)][(saoPtr->saoTypeIndex[isChroma]) - 3][((lcuWidth & 15) == 0) && (lcuWidth >= 32) && ((lcuHeight & 7) == 0) && (lcuHeight >= 8)](
            reconSamplePtr,
            reconStride,
            temporalBufferLeft,
            temporalBufferUpper,
    ...
    case 5: // BO
        ...
        SaoFunctionTableBo_16bit[!!(ASM_TYPES & AVX2_MASK)][((lcuWidth & 15) == 0)](
            reconSamplePtr,
            reconStride,
            saoPtr->saoBandPosition[videoComponent],
            OrderedsaoOffsetBo,
